...
const styles = StyleSheet.create({
  ...
  statusRow: { flexDirection: "row", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap" },
  status: { color: "#bdcedb", fontSize: 15 },
  resetButton: { minHeight: 44, paddingHorizontal: 12, justifyContent: "center" },
  canvas: { flex: 1, minHeight: 180, overflow: "hidden", marginTop: 12 },
  liquid: { flex: 1 },
  backgroundCircle: {
    position: "absolute", width: 280, height: 280, borderRadius: 140,
    backgroundColor: "#315766", left: -100, top: "30%",
  },
  backgroundStripe: {
    position: "absolute", width: 110, height: "130%",
    backgroundColor: "#314251", right: 28, top: -50,
